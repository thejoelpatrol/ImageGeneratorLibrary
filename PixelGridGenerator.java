...
public abstract class PixelGridGenerator {
	...
	/**
	 * Generates a grid of ints according to some algorithm, chosen by the implementation, which are suitable for use as RGB color values with no alpha (fully opaque)
